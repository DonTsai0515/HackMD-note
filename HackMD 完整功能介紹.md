...
參考源：[官方文件_功能介紹](https://hackmd.io/c/tutorials-tw/%2Fs%2Ffeatures-tw)
...
## 上傳圖片
只要按下這個按鈕 <i class="fa fa-photo"></i>，這會自動上傳圖片至 **[imgur](http://imgur.com)** 


## 分享筆記
按下選單右上角的分享按鈕 <i class="fa fa-share-alt"></i>，可按 **複製** 按鈕將筆記網址複製到您的剪貼簿

## 儲存
目前可以儲存至 **Dropbox** <i class="fa fa-dropbox"></i>、**Google Drive**、**Gist <i class="fa fa-github"></i>** 或是存放 **.md** <i class="fa fa-file-text"></i> 到您的本機

## 匯入
可以從 **Dropbox** <i class="fa fa-dropbox"></i>、**Google Drive**、**GitHub <i class="fa fa-github"></i>** 匯入 **.md** <i class="fa fa-file-text"></i>
或是從 **剪貼簿** <i class="fa fa-clipboard"></i> 匯入，而且這可以轉換成 **HTML**

## 權限
選單右上角的分享按鈕 <i class="fa fa-share-alt"></i>，按下之後您會看到分享選單
對於筆記的 **可閱讀**、**可編輯** 權限，您可以選擇：**擁有者**、**已登入者**、**所有人**

對於筆記的 **留言** 權限，請先在分享選單中按 **更多設定** 的按鈕，您可以選擇：**不開放留言**、**擁有者**、**已登入者**、**所有人**
*可以透過留言選項右上角的 開關 <i class="fa fa-toggle-on"></i> ，直接關閉留言功能*
...
或是也可以使用嵌入語法來無縫引用筆記，請閱讀 **[在筆記中嵌入另一篇筆記](https://hackmd.io/c/tutorials-tw/%2Fs%2Fhow-to-embed-note-tw)**

## [簡報模式](/slide-example)
可以使用語法將您的筆記分成投影片
用 **簡報模式** <i class="fa fa-tv"></i> 來展示，詳細請至上連結

## [書籍模式](/book-example)
可以將筆記彙整成一本書
將筆記連結列成清單然後用 **書籍模式** <i class="fa fa-book"></i> 來展示，詳細請至上連結

檢視
===
## 目錄
檢視區塊的右下角，有個 _目錄_ 的小按鈕 <i class="fa fa-bars"></i>
...
>>> 再一個巢狀引用
> [name=Don Tsai] [time=Sun, Jan 15, 2023 03:40 PM] [color=grey]
...
Hiiii :stuck_out_tongue_winking_eye:
:::
